if (window.desktopApp)
  desktopApp.wins = {
          ...
          body: {
            ...
            template: function (obj) {
              ...
              if (obj.img) {
                ...
                icon =
                  "<span class='webix_icon mdi mdi-" + obj.icon + "'></span>";
              }
              return (
                "<div class='empty-app-inner' style='background-color:" +
                obj.color +
                ";'>" +
                icon +
                "</div>"
    ...
    showApp: function (name) {
      ...
      // else if (name == "gantt" && window.gantt) gantt.render();
      desktopApp.wins.setActiveStyle(winId);
    },
    ui: {
