  ...
  init: function () {
    ...
    webix.attachEvent("onFocusChange", function (view) {
      if (view) {
        ...
        // filemanager case
        if (win.getParentView()) win = win.getParentView().getTopParentView();
              ...
              rows: [
                {
                  ...
                  height: 60,
                  template:
                    "<div><img class='user-logo' src='img/user_logo.png'/> <span>Yan Tsishko</span></div>",
                },
                {
                  view: "label",
                ...
                },
                {
                  ...
                  css: "start-menu-list",
                  template:
                    "<div class='desktop-icons start-menu-item'><div class='start-menu-item-image-bg'><img class='start-menu-item-image' src='#image#' ></div><div class='start-menu-item-image-title'>#title#</div></div>",
                  type: {
                    height: 36,
                  },
                  select: true,
                ...
                },
                {
                  ...
                  template: function (obj) {
                    ...
                    return (
                      "<div class='menu-sys-icon' style='background-image:url(" +
                      obj[icon] +
                      ")'></div>" +
                      obj[value]
                    );
                  ...
                  data: [
                    {
                      id: "full-screen",
                      value: "Full screen",
                      value1: "Exit full screen",
                      image: "img/fullscreen.png",
                      image1: "img/fullscreen-exit.png",
                      state: 0,
                    },
                    {
                      id: "sign-out",
                      value: "Sign out",
                      image: "img/signout.png",
                    },
                  ],
                  on: {
                    onItemClick: function (id) {
      ...
      webix.ui({
        ...
        on: {
          onItemClick: function () {
            ...
            else if (winId == "gantt_win" && window.gantt) gantt.render();
